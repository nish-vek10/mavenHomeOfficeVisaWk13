...
//***************************** Is Display Methods **********************************************//
    ...
    public void clickOnAcceptCookies() throws InterruptedException{
        Thread.sleep(25);
        WebElement acceptCookies = driver.findElement(By.xpath("//div[@class='govuk-button-group']" +
                "/button[text()='Accept additional cookies']"));
        WebElement hideMessage = driver.findElement(By.xpath("//button[text()='Hide this message']"));
        clickOnElement(acceptCookies); //call method from Utility class
        clickOnElement(hideMessage); //call method
    }
}
